...
public class AdminBorrowerController {
    ...
    public R listPage(
            ...
            @ApiParam(value = "查询关键字", required = false) // 这里的@RequestParam其实是可以省略的，但是在swagger版本中(2.9.2)不能省略，否则默认将没有注解的参数解析为body中传递的参数
            @RequestParam String keyword) {  // keyword 可以是姓名/手机号/身份证号，作为分页查询的条件
    ...
    public R show(
            ...
            @PathVariable Long id) {  // 对应borrower表中的id
