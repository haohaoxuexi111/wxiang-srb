...
public class UserInfo implements Serializable {
    ...
    // 用户的默认头像url
    public static final String USER_AVATAR = "https://oss-srb-space-1.oss-cn-shenzhen.aliyuncs.com/avatar/favicon.ico";
    ...
    @JsonFormat(pattern = "yyyy-MM-dd")  // 只为当前列指定个性化时间格式
